    ...
    <div className='policy-sec'>
      <div className='container-wrap'>
        ...
        <div className='para-txt'>
          ...
          <p>
            To start a return , you can contact us at contact@tangibleweb3.com.. If your return is
            accepted, we’ll send you a return shipping label, as well as instructions on how and
            where to send your package. Items sent back to us without first requesting a return will
            not be accepted.
          </p>
          <p>You can always contact us for any return question at contact@tangibleweb3.com. </p>
